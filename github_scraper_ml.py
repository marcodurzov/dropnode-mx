...
def main():
    ...
    if es_horario_free:
        ...
        # Resumen si no hubo alertas a mediodia o 7pm
        if free_n == 0 and hora in (12, 19) and unicos:
            ...
            for i, it in enumerate(top, 1):
                ...
                if it.get("tiene_cupon"):
                    ln += " 🎟️"
                ln += "   <a href=\"" + link_ml(it["url"], it["id"]) + "\">Ver oferta</a>"
                msg += ln + "\n\n"
            if LAUNCHPASS_LINK:
